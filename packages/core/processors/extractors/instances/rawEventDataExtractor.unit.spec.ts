...
describe('makeRawLogExtractors', () => {
  it('works with mixed address list with starting block', () => {
    const def = [
      ...
      { address: '0x0511674a67192fe51e86fe55ed660eb4f995bdd6', startingBlockNumber: 10 },
    ];
    ...
    expect(extractors[0].startingBlockNumber).toBe(undefined);
    expect(extractors[1].name).toBe('raw_log_0x0511674a67192fe51e86fe55ed660eb4f995bdd6_extractor');
    expect(extractors[1].startingBlockNumber).toBe(10);
  });
});
